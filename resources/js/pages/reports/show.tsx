            ...
            <div className="space-y-6 p-4">
                        ...
                        description={
                            ...
                            (report.period?.name
                                ...
                                : report.start_date && report.end_date
                                  ? `${dayjs(report.start_date).format('DD/MM/YYYY')} al ${dayjs(report.end_date).format('DD/MM/YYYY')}`
                                  : 'Sin periodo')
                        }
                    />
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Información general del colaborador evaluado.
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="grid gap-3 text-sm md:grid-cols-2 xl:grid-cols-4">
                        ...
                        <div>
                            ...
                            <p className="font-medium">
                                {report.collaborator.area} /{' '}
                                {report.collaborator.position}
                            </p>
                        </div>
                        <div>
                            <p className="text-xs text-muted-foreground">
                            ...
                            <p className="font-medium">
                                {report.collaborator.immediate_supervisor}
                            </p>
                        </div>
                        <div>
                            <p className="text-xs text-muted-foreground">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Cálculo automático por competencia y categoría.
                        </CardDescription>
                    </CardHeader>
                            ...
                            <div className="rounded-lg border">
                                ...
                                <div className="overflow-x-auto">
                                    <table className="w-full min-w-120 text-sm">
                                        ...
                                        <tbody>
                                            {summary.by_competency.map(
                                                (item, index) => (
                                                    <tr
                                                        key={
                                                            item.competency_id ??
                                                            `${item.competency_name ?? 'competency'}-${index}`
                                                        }
                                                        className="border-b last:border-none"
                                                    >
                                                        <td className="px-3 py-2">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Puntuaciones detalladas por pregunta y competencia.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div className="overflow-x-auto">
