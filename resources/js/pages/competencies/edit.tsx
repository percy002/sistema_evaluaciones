...
type Payload = { id: number; evaluation_type_id: number; evaluation_category_id: number | null; name: string; description: string | null; sort_order: number };

export default function CompetenciesEdit({ competency, types, categories }: { competency: Payload; types: TypeOption[]; categories: CategoryOption[] }) {
    const { data, setData, patch, processing, errors } = useForm({
        evaluation_type_id: String(competency.evaluation_type_id),
        evaluation_category_id: competency.evaluation_category_id ? String(competency.evaluation_category_id) : '',
